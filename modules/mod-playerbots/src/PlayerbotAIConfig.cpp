#include <Config.h>
void PlayerbotAIConfig::LoadStuckBotConfig() {
    stuckBotLevelThreshold = sConfigMgr->GetOption<uint32>("AiPlayerbot.StuckBotLevelThreshold", 6);
    stuckBotStartzoneTimeout = sConfigMgr->GetOption<uint32>("AiPlayerbot.StuckBotStartzoneTimeout", 300);
    stuckBotInactivityTimeout = sConfigMgr->GetOption<uint32>("AiPlayerbot.StuckBotInactivityTimeout", 180);
}
/*
